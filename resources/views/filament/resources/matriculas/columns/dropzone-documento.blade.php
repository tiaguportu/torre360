...
>
    <div
        ...
        "
        :class="{
            'border-primary-500 bg-primary-50 dark:bg-primary-900/10': isDropping,
            'border-gray-300 dark:border-gray-700': !isDropping
        }"
        class="flex flex-col items-center justify-center p-2 transition-all border-2 border-dashed rounded-lg cursor-pointer hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/10"
    ...
    >
        <template x-if="!isUploading">
            <div class="flex items-center gap-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                ...
                />
                <span class="group-hover:text-primary-600 transition-colors">Arraste aqui</span>
            </div>
        </template>
        ...
        <template x-if="isUploading">
            <div class="w-full">
                <div class="flex items-center justify-between mb-1">
                    <span class="text-[10px] font-medium text-primary-600 animate-pulse">Enviando...</span>
                    <span class="text-[10px] font-medium text-primary-600 font-mono" x-text="progress + '%'"></span>
                </div>
                <div class="w-full h-1.5 bg-gray-200 rounded-full dark:bg-gray-700 overflow-hidden">
                    <div
                        class="h-full transition-all duration-300 bg-primary-600 rounded-full shadow-[0_0_8px_rgba(var(--primary-600),0.5)]"
